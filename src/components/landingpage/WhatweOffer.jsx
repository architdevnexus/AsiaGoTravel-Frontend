...
export const WhatWeOfferComponent = () => {
  const images = [
    { src: "/img/aboutimg1.jpg", text: "Honeymoon Trips", href: "/honeymoon-trips" },
    { src: "/img/aboutimg2.jpg", text: "Family Holidays", href: "/family-holidays" },
    { src: "/img/aboutimg5.jpg", text: "Bachelor Tours", href: "/bachelor-tours" },
    { src: "/img/aboutimg3.jpg", text: "Luxury Tours", href: "/luxury-tours" },
    { src: "/img/aboutimg4.png", text: "Premium Holiday Packages", href: "/premium-holiday-packages" },
  ];
