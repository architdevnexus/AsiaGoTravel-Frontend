...
export default function HomePageSearchPackages() {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-6 bg-[#F8FBFF] shadow-md drop-shadow-white mx-25 ">
      <h2 className="text-lg font-semibold mb-4 text-[#4D4D4D]">
        Search for Packages
      </h2>

      <div className="bg-white shadow-md rounded-lg p-6 w-[90%] md:w-[95%] lg:w-[90%] xl:w-[90%] border border-gray-200">
...
<div className="flex flex-col w-full md:w-1/5">
  ...
  <span className="text-xs text-gray-400">
    {new Date(departureDate).toLocaleDateString("en-GB", {
      ...
      {/* Search Button */}
      <button className="absolute top-[790px] mt-6 flex items-center gap-4 bg-[#28A9E0] hover:bg-[#1C94C9] text-white font-medium px-10 py-2 rounded-full shadow-md transition">
        <FaSearch />
        Search
      </button>
    </div>
