...
export const TeamSection = () => {
  ...
  return (
    <section className="bg-[#F9FCFF] py-10 px-6 lg:px-10 flex flex-col lg:flex-row items-center justify-between gap-10 overflow-hidden">
      {/* Left Section */}
      <div className="flex flex-col items-start space-y-6 pt-10 max-w-sm">
        <h2 className="text-4xl font-bold text-black leading-12 font-[Nunito Sans]">
      ...
      {/* Team Cards Section */}
      <div
        className="flex gap-6 justify-center items-center select-none relative overflow-hidden"
      ...
      >
        ...
        <div className="relative w-72 h-[380px] flex justify-center items-center">
          <AnimatePresence custom={direction}>
            <motion.div
              ...
              className="bg-black text-white rounded-lg w-72 h-[380px] flex flex-col items-center justify-end relative shadow-lg cursor-grab active:cursor-grabbing"
            >
        ...
        {/* Right Faded Cards with subtle motion */}
        <motion.div
          key={`side1-${index}`}
          ...
          className="bg-[#EBEBEB] rounded-lg w-55 h-[340px] flex flex-col items-center justify-center"
        >
          <Image
            src={getMember(1).img}
        ...
        <motion.div
          ...
          exit={{ x: direction > 0 ? -80 : 80, opacity: 0.3, scale: 0.95 }}
          transition={{ duration: 0.5, ease: "easeInOut" }}
          className="bg-[#EBEBEB] rounded-xl w-55 h-[340px] flex flex-col items-center justify-center"
        >
          <Image
            src={getMember(2).img}
